...
```transcript.level.zebrafish.dev.stage``` plots the transcription level of a gene (specified by ```EmsemblID```) throughout the course of zebrafish embryonic development. Requires the [data file](https://figshare.com/ndownloader/files/46453495) containing normalized counts reanalyzed from [White et al., 2017](https://elifesciences.org/articles/30860) ([PRJEB12982](https://www.ncbi.nlm.nih.gov/bioproject/?term=PRJEB12982); [metadata](https://figshare.com/ndownloader/files/46453492)). There are also other similar studies like [Akinmusola et al., 2026 (on Aphaniops dispar)](https://www.biorxiv.org/content/10.64898/2026.07.17.738637v1.full), [Aponte-Santiago, Su, and Wagner, 2026](https://www.biorxiv.org/content/10.64898/2026.03.23.713599v1), [Yang et al., 2013](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0064058), [Mathavan et al., 2005](https://journals.plos.org/plosgenetics/article?id=10.1371/journal.pgen.0010029), and [Bozinovic, Sit, Hinton & Oleksiak, 2011 (on _Fundulus heteroclitus_)](https://link.springer.com/article/10.1186/1471-2164-12-132). An example plot of _myl7_ (_cmlc2_) is shown below.
