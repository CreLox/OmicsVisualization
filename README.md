...
**See also** ```UniProtGOFilter``` and the ultimate [GO annotations from QuickGO](https://www.ebi.ac.uk/QuickGO/annotations?taxonId=105023&qualifier=part_of,located_in,is_active_in,involved_in,enables,contributes_to,colocalizes_with,acts_upstream_of_or_within&proteome=gcrpCan,gcrpIso&geneProductType=protein).
