...
```CompileGOList.FromQuickGOAnnotations``` compiles GO annotations from QuickGO ([example](https://www.ebi.ac.uk/QuickGO/annotations?taxonId=105023&qualifier=part_of,located_in,is_active_in,involved_in,enables,contributes_to,colocalizes_with,acts_upstream_of_or_within&proteome=gcrpCan,gcrpIso&geneProductType=protein)), which is more comprehensive than Ensembl BioMart. Note that exporting the TSV file of all GO annotations from the QuickGO website may take ~ 1 hour.
